...
export declare const createSchemaRoutes: <TEntityMap>(schemaMap: import("@mojule/util").KeyValueMap<TEntityMap, import("../../schema/types").IdSchema>) => SchemaRoute<TEntityMap>[];
