...
export declare const createRefSchemaMap: <TEntityMap>(entitySchemas: import("../util/types").KeyValueMap<TEntityMap, IdSchema>, createRef: (name: string) => DbRefSchema) => SchemaMap;
