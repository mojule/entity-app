import { EntityDb, DbCollection, DbIds, DbItem, EntitySchemaDb } from '../../db/types'
import { postRoute } from './post-route'
import { getRoute } from './get-route'
import { KeyValueMap } from '../../util/types'
import { Method, StoreRoute, GetPath, GetResult, ActionType } from './types'
...
import { resolveRefsDeep, resolveRefsShallow } from '../../db/ref'
...
export const defaultGetResult = async <TEntityMap>(
  ...
  log.info(
    'Store GET', { collectionKey, action, type }
  )
...
export const defaultPostResult = async <TEntityMap>(
  ...
  log.info(
    'Store POST', { collectionKey, action, type }
  )
